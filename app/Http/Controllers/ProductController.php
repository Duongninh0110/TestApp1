...
class ProductController extends Controller
{
    public function addProduct(Request $request){
    	...
    	if($request->ismethod('post')){
			...
			return redirect('admin/view-products')->with('flash_message_success', 'The product has been added successfully');
    ...
    public function editProduct(Request $request, $id){
    	...
    	if($request->ismethod('post')){
    		...
    		return redirect('admin/view-products')->with('flash_message_success', 'The product has been edited successfully');
