    ...
    <header>
      ...
      <div class="collapse navbar-collapse" id="myNav"> 
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a href="{{url('/admin/add-product')}}" class="nav-link" ">Thêm Sách</a></li>
          <li class="nav-item"> <a href="{{url('/admin/view-products')}}" class="nav-link">Xem Kho Sách</a></li>
          @if(empty(Auth::check()))
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <p>(Khu vực chỉ dành cho Admin)</p>
