...
class CategoryController extends Controller
{
    public function addCategory(Request $request){
    	if($request->ismethod('post')){
    		...
    		return redirect('admin/view-categories')->with('flash_message_success', 'This  Category has been added succesfully');
    	}
    ...
    public function editCategory(Request $request, $id){
        ...
        $levels = Category::get();
        return view('admin.categories.edit_category')->with('levels', $levels)->with('categoryDetails', $categoryDetails);
    ...
    public function deleteCategory($id){
    	...
    	$Category ->delete();
    	return redirect('admin/view-categories')->with('flash_message_success', 'This  Category has been deleted succesfully'); 
